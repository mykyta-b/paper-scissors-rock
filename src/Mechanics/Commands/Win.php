...
class Win extends CommandTemplate
{
    protected $commandState = MechanicsConstants::WIN;
    ...
    public function execute(GameDTO $gameDTO, GameStateInterface $gameState): void
    {
        ...
        $this->renderer->renderPhrase("Win!");
        $this->renderer->renderPhrase("Congrats to player");
        $this->renderer->renderPhrase($gameDTO->getWinner()->getName());
        $this->renderer->renderGameResult($gameDTO->getPlayers());
